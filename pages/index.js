...
const photos = importAll(require.context('../public/gallery/', false, /\.(png|jpe?g|gif)$/)).reverse();

const imgElements = photos.map(photo => {
	return <Image src={photo.src} className="w-64" width={300} height={300} key={photo.id} />;
});
